-- Published / store / live app links (labeled URL list, same shape as github_links).

ALTER TABLE public.projects
  ADD COLUMN IF NOT EXISTS published_links jsonb NOT NULL DEFAULT '[]'::jsonb;
...
-- Promotion: copy pool item published_links onto the new project.
